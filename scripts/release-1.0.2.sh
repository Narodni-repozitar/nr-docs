...
invenio oarepo oai harvester add nusl-manual-submissions --name "Manual submissions NUSL harvester" \
            ...
            --writer 'timestamp_update{service=documents,date_created_csv_path="https://raw.githubusercontent.com/Narodni-repozitar/nr-docs/refs/heads/main/scripts/datecreated.csv"}'
