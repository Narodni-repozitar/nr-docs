...
def create_api_blueprint(app):
    """Create NrDocumentsFileDraft blueprint."""
    blueprint = app.extensions["nr_documents"].resource_draft_files.as_blueprint()
    ...
    funcs = [
        ...
        if k.startswith("init_addons_nr_documents_file_draft") and callable(v)
    ]
    for func in funcs:
