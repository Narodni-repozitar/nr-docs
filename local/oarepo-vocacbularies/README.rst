...
.. code:: sh
    ...
    $ python3 -m venv $VENV
    $ $VENV/bin/pip install oarepo-vocacbularies
...
.. code:: sh
    ...
    $ export VENV=~/path/to/venv
    $ python3 -m venv $VENV
    $ cd /path/to/oarepo-vocacbularies
...
.. code:: sh
    ...
    c:\> %VENV%\Scripts\pip install oarepo-vocacbularies
...
.. code:: sh
    ...
    c:\> set VENV=c:\path\to\venv
    c:\> python -m venv %VENV%
    c:\> cd \path\to\oarepo-vocacbularies
