...
def create_api_blueprint(app):
    """Create DocumentsFileDraft blueprint."""
    blueprint = app.extensions["documents"].resource_draft_files.as_blueprint()
    ...
    funcs = [
        ...
        if k.startswith("init_addons_documents_file_draft") and callable(v)
    ]
    for func in funcs:
