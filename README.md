...
Here's Mirek from the same company (CESNET) as mirekys. I'd just add that for our
ongoing "Czech National Repository Platform" project the direct multipart
upload to S3 is vital, as our users have already been using this form of
upload both in our repositories based on older versions of Invenio 3 and in
the LTP service we provide.
We have started migrating our codebase to RDM 12 and the plan was to have 
the S3 layer ported by the end of Q1. With what you do we'd rather not split 
forces and use your solution. If you'd like a hand with development or testing, 
let us know.
